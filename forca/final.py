...
estados = [
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado0.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado1.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado2.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado3.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado4.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado5.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/forca/imagens/estado6.png"), (largura_desejada, altura_desejada))
]

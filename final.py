...
estados = [
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado0.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado1.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado2.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado3.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado4.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado5.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("downloads/jogo-da-forca-main/imagens/estado6.png"), (largura_desejada, altura_desejada))
]
...
# Variáveis do jogo
palavras = ['GATO', 'CACHORRO', 'GIRAFA', 'ELEFANTE','AMEIXA','GRAVIOLA','BANANA','ACEROLA','GELADEIRA', 'CAMA','NOTEBOOK','ESPELHO']
palavra_secreta = ""
letras_descobertas = []
letras_tentadas = []
erros = 0

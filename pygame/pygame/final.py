...
estados = [
    pygame.transform.scale(pygame.image.load("pygame/estado0.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("pygame/estado1.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("pygame/estado2.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("pygame/estado3.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("pygame/estado4.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("pygame/estado5.png"), (largura_desejada, altura_desejada)),
    pygame.transform.scale(pygame.image.load("pygame/estado6.png"), (largura_desejada, altura_desejada))
]
